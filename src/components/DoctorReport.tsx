	...
	return (
		<div className="p-6">
			<div className="flex justify-between items-center mb-6">
				<h3 className="text-lg font-semibold text-amber-900">Doctor Report</h3>
				{report && (
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<div className="flex items-end">
						<button
							...
							className="w-full flex items-center justify-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:bg-gray-400 transition-colors"
						>
							{generating ? (
								<>
					...
					<div className="p-6 space-y-6">
						...
						<div>
							...
							<div className="space-y-3">
								{report.entries
									.slice(0, 5)
									.map((entry: SymptomEntry, index: number) => (
										<div
											key={entry.id}
											className="flex justify-between items-start border-l-4 border-indigo-500 pl-4 py-2"
										>
											<div>
				...
				<div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
					...
					<ul className="text-sm text-blue-800 space-y-2">
						<li className="flex items-start">
							...
							Select the date range for symptoms you want to include in the
							report
						</li>
						<li className="flex items-start">
							<span className="text-blue-600 mr-2">2.</span>
							Click &quot;Generate Report&quot; to create an AI-powered health
							summary
						</li>
						<li className="flex items-start">
							<span className="text-blue-600 mr-2">3.</span>
							Export or print the report to share with your healthcare provider
						</li>
						<li className="flex items-start">
							<span className="text-blue-600 mr-2">4.</span>
							The report includes symptom patterns, severity trends, and AI
							insights
						</li>
					</ul>
				</div>
